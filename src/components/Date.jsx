...
export const Date = () => {
    return <>
   <div className="flex  h-fit  md:flex-nowrap flex-wrap items-center gap-3 md:gap-5 ">
   <div
           data-aos="fade-up" data-aos-delay=""
         className="rounded-full  bg-gradient-to-l to-red-500 to-30% from-pink-600 w-fit flex gap-1 p-1  text-sm mb-2 items-center sm:font-semibold">
            <motion.span >
            ...
            <span className="uppercase text-sm  sm:text-md pl-0 sm:pl-0 sm:p-2 p-1  ">
                25 au 26 Août 2023 
            </span>
        </div>
