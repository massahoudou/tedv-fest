...
const TimeCard = ({time,title,first }) => {
    return <>
         <div className={`${first ? 'border-[1.5px] bg-transparent': 'bg-white/20 backdrop-blur-xl' } w-[8rem] h-[6rem]   lg:min-w-[13rem] lg:min-h-[13rem] flex items-center  justify-center shadow-2xl md:rounded-lg`}>
