...
const SectionContact = () => {
    return <section id="contact" className="relative h-fit py-20 bg-black text-white text-lg overflow-hidden " data-aos="fade-up" data-aos-delay="">
            ...
            <div className="border-b-[1px] border-white/30 pb-14 ">
                ...
                <div className="text-center flex  flex-wrap md:flex-nowrap justify-between mt-10">
                    ...
                    <div className="md:mt-0 mt-10" data-aos="fade-up" data-aos-delay="200">
                        <div className="text-xl mb-5 text-left font-bold">Nos reseaux Sociaux</div>
                        <div className="flex gap-10 ">
                            ...
                            <Link href="#" passHref >
                                ...
                                <svg class="social-link" xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" viewBox="0 0 16 16">
