const Program = ({item }) => {
    ...
    <div className="w-full p-2  relative "  data-aos="fade-up">
        <div className={` ${key + 1 < item.content.length ?"before:absolute  before:h-full before:border-[1px] before:border-dashed  before:border-primary before:-z-10" : ""} `}>
